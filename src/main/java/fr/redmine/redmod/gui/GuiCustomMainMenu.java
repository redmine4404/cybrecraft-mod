...
public class GuiCustomMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        if (calendar.get(2) + 1 == 2 && calendar.get(5) == 21)
        {
            this.splashText = "Happy birthday, redmine4404!";
        }
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(this.RedBlock = new GuiButton(20, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2 - 70, "connect to CyberCraft"));
        fmlModButton.xPosition = this.width / 2 + 2;
        realmsButton.width = 98;
        fmlModButton.width = 98;
        this.buttonList.add(realmsButton);
        this.buttonList.add(fmlModButton);
        RedBlock.enabled = Reference.onServer;
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        if(button.id == 20)
        {
            ...
            FMLClientHandler.instance().connectToServerAtStartup(Reference.ServerIP, Reference.ServerPORT); // ip, port
        }
